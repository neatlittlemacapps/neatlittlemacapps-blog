---
title: "The Bot Chronicles SO1 E01: crashcourse"
meta_title: ""
description: "Hi again and welcome to the first chapter, Episode 1 of the Bot Chronicles series. I feel we got off a bit on the wrong foot in our initial…"
date: "2017-01-25T09:48:43Z"
image: "https://cdn-images-1.medium.com/max/1200/1*wA8Xu0LmcnPxfKJKJiPQ4Q.jpeg"
categories: ["Archive"]
...
{{< figure src="https://cdn-images-1.medium.com/max/2560/1*wA8Xu0LmcnPxfKJKJiPQ4Q.jpeg" alt="Bots will venture out into all kinds of new biotopes. Biotopes other media just can’t reach. — Image byThe Reference." caption="Bots will venture out into all kinds of new biotopes. Biotopes other media just can’t reach. — Image byThe Reference." >}}
...
{{< figure src="https://cdn-images-1.medium.com/max/800/0*dUgyAQ6hlpYREe1T." alt="Geekbot in use for standup meetings @The Reference" caption="Geekbot in use for standup meetings @The Reference" >}}
...
{{< figure src="https://cdn-images-1.medium.com/max/800/1*4Mv4C-jvpMynWQoDCe6xow.png" alt="Messaging apps are a very common bot biotope. — image byThe Reference" caption="Messaging apps are a very common bot biotope. — image byThe Reference" >}}
...
{{< figure src="https://cdn-images-1.medium.com/max/800/1*LEykLjxY873J44oxaxr-Xw.png" alt="Bots migrate to other biotopes websites can’t reach, like your livingroom. — image byThe Reference" caption="Bots migrate to other biotopes websites can’t reach, like your livingroom. — image byThe Reference" >}}
...
- LGcame out with the LG Hub (powered by Amazon’s Alexa)
- Lenovojumped on board too with the Alexa (again) powered Harman Kardon speakers
- EvenMatteldabbles in the pool (oh dear)
- And of course we must not forgetcarsand thestray fridge!
...
{{< figure src="https://cdn-images-1.medium.com/max/1200/1*wA8Xu0LmcnPxfKJKJiPQ4Q.jpeg" alt="Bots will venture out into all kinds of new biotopes. Biotopes other media just can’t reach. — Image byThe Reference." caption="Bots will venture out into all kinds of new biotopes. Biotopes other media just can’t reach. — Image byThe Reference." >}}
...
**Missed out** on the Bot Chronicles first article? [Read it here](https://medium.com/@neatlittlemacapps/bot-chronicles-intro-debe30df5bd#.pzamhz7lp).
