...
date: "2017-05-18T12:42:10Z"
image: "https://cdn-images-1.medium.com/max/2560/1*aA8RfHb3gGRA4RcvuyAsvQ.png"
categories: ["Archive"]
...
{{< figure src="https://cdn-images-1.medium.com/max/2560/1*aA8RfHb3gGRA4RcvuyAsvQ.png" >}}
...
- Forwhomare we building a bot? (link to episode 5)
- Whois our bot?
...
{{< figure src="https://cdn-images-1.medium.com/max/800/0*Tpgz6yDDQXnxp7cb." >}}
...
You can download the personality definition template here


## Step 1: define personality traits


As it turns out, one of my collegues has a degree in psychology. Handy. So we had a chat about this subject. Turns out, there are quite some personality traits. Don’t believe me? Try this one on for size: [http://ideonomy.mit.edu/essays/traits.html](http://ideonomy.mit.edu/essays/traits.html)  
 Yeah. I know.


Then I included our strategy team in the discussion. I knew these guys had good results with, for example, our client [Melexis](http://www.melexis.com/) in a “brandhouse” project.


They have methodologies for defining a “brand hero” based on brand archetypes (like [this](https://www.google.com/search?q=brand+archetype)). This isn’t exactly a one on one with defining a bot personality, but whatever personality you end up with should be in line with the brand, and it was good input for the next exercise.
...
{{< figure src="https://cdn-images-1.medium.com/max/800/0*CNRMk0MHcSr9BM2i." >}}
...
{{< figure src="https://cdn-images-1.medium.com/max/800/0*-QtJMHg0mBWeiyyf." >}}
...
{{< figure src="https://cdn-images-1.medium.com/max/800/0*_vnEXELvEvt2zQ-m." >}}
...
{{< figure src="https://cdn-images-1.medium.com/max/800/0*9b5odeYrStGNFegp." >}}
